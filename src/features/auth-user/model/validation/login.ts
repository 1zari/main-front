...
export const userSchema = z.object({
  name: z.string().min(1, "이름은 필수입니다.").max(15, "최대 15자까지 입력 가능합니다."),
  phone: z
    .string()
  ...
  purposes: z.array(z.string()).min(1, "가입 목적을 1개 이상 선택해주세요."),
  channels: z.array(z.string()).min(1, "유입 경로를 1개 이상 선택해주세요."),
});
