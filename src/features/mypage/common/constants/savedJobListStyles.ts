...
export const JOB_LIST_STYLES = {
  ...
  table: {
    ...
    header: {
      wrapper: "flex items-center border-b border-gray-200 h-14 bg-gray-50 px-4",
      column: {
        base: "font-semibold text-gray-600 flex items-center overflow-hidden",
        scrap: "w-[8%] justify-center",
        info: "w-[33%]",
        location: "w-[17%] justify-center",
        salary: "w-[17%] justify-center",
    ...
    row: {
      wrapper:
        "flex items-stretch min-h-[5rem] hover:bg-gray-50 cursor-pointer group transition-colors px-4",
      column: {
        base: "flex items-center overflow-hidden",
        scrap: "w-[8%] justify-center",
        info: "w-[33%] py-3 flex-col items-start justify-center",
        location: "w-[17%] justify-center text-gray-600",
        salary: "w-[17%] justify-center text-gray-600",
        type: "w-[13%] justify-center",
